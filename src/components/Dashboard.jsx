...
const Dashboard = ({ userPhoto, userName, userEmail, fullPageStyle }) => {
  ...
  return (
    <div className="container w-full h-full relative py-10 px-10 md:px-20" style={fullPageStyle}>
      {/* logo and login details */}
      ...
      <div className="md:flex justify-center items-center mb-5">
        <input
          ...
          aria-label="input"
          value={channelInput}
          className="rounded-3xl py-2 px-4 bg-white mr-8 w-full lg:w-1/2 outline-none"
          placeholder="Enter channel url"
          onChange={handleInputChange}
        />
        <button
          className="rounded-3xl py-2 bg-white w-60 hover:bg-limeGreen hover:text-white mt-2 md:mt-0"
          onClick={handleClick}
        >
          Get channel info
        </button>
      ...
      {channelDetails && (
        ...
        // channel-about
        <div className="lg:grid grid-cols-5 mb-4 gap-10">
          {/* channel info */}
          <div className="bg-white rounded-md py-8 px-6  flex flex-col items-center col-span-1">
            ...
            <div className="py-2 px-4 rounded-3xl w-1/2 lg:w-full bg-red text-center">
          ...
          {/* channel-stats */}
          <div className="bg-white rounded-md py-2 px-6 w-full md:col-span-4">
            <h3>Channel overview</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 py-4 gap-6">
